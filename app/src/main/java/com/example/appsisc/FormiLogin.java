...
// igor 
            ...
            new ActivityResultCallback<FirebaseAuthUIAuthenticationResult>() {
                ...
                private void onSignInResult(FirebaseAuthUIAuthenticationResult result) {
                    ...
                    if (result.getResultCode() == RESULT_OK) {
                        ...
                        applicationInstance.state.setLoggedUser(user);
                        Intent nextPage = new Intent(FormiLogin.this, TelaPrincipal.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_entrar.setOnClickListener(view -> {
            try {
                signInLauncher.launch(this.signIn);
    ...
    private void iniciarComponentes(){
        this.text_tela_cadastro = findViewById(R.id.text_tela_cadastro);
        this.bt_entrar = findViewById(R.id.bt_entrar);
    }
